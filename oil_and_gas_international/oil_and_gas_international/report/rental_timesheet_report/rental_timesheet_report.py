...
def get_columns(filters):
  columns = [
	...
	{'fieldname': 'daily_rental_rate','label': _('Daily Rental Rate'),'fieldtype': 'currency','width': 150},
	{'fieldname': 'daily_rental_total','label': _('Daily Rental Total'),'fieldtype': 'currency','width': 150},
